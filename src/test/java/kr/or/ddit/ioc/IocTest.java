...
public class IocTest {
	...
	public void beanScopeTest() {
		...
		// 디자인 패턴의 singlton 개념으로 보면 두 개념의 객체는 한 클래스로부터 나왓으므로 동일 해야함 
	...
	public void beanScopeTest2() {
		...
		// 동일한 스프링 빈을 주입받았으므로 userSerivce, userService2는 같은 객체다
		assertEquals(userService, userService2);
	}
	
	@Test
	public void beanScopePropotypeTest() {
	...
	public void propertyPlaceholderTest() {
		...
		assertEquals("doyeong", dbConfig.getUsername());
